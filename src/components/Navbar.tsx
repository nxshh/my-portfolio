      ...
      <div className="container mx-auto px-6">
        <div className={`glass rounded-2xl border border-white/5 px-6 py-3 flex items-center justify-between transition-all duration-300 ${isScrolled ? 'bg-background/80 backdrop-blur-xl' : 'bg-transparent'}`}>
          <a href="#" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-full border border-primary/30 flex items-center justify-center group-hover:border-primary transition-colors">
              <TerminalIcon className="w-4 h-4 text-primary" />
            </div>
            <span className="font-heading italic font-light text-2xl tracking-tight">Nisarga</span>
          </a>
